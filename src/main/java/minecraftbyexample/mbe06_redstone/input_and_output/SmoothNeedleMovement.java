...
public class SmoothNeedleMovement {
  ...
  /**
   * Create a new smooth needle movement:
   * The needle position has units of "from 0.0 to 1.0".
   * @param needleAcceleration acceleration in units per square second
   * @param needleMaxSpeed maximum needle movement speed in units per second
   */
