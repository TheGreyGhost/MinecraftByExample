...
// * This class modifies the displayed block base model to add a meter needle on each of the four block sides.
// * The needle moves to show the current power level of the block.
// *
// */
//public class RedstoneMeterSmartBlockModel implements ISmartBlockModel
//{
//
//  /**
...
//   */
//  public RedstoneMeterSmartBlockModel(IBakedModel i_basemodel, int i_powerLevel)
//  {
//    baseModel = i_basemodel;
//    powerLevel = i_powerLevel;
//  }
//
...
//
//  // Use the stored power level information to add extra BakedQuads to the list of Quads to be rendered.
//  @Override
//  public List getGeneralQuads() {
//    List<BakedQuad> combinedQuadsList = new ArrayList(baseModel.getGeneralQuads());
//    combinedQuadsList.addAll(getNeedleQuads(EnumFacing.EAST));
//    combinedQuadsList.addAll(getNeedleQuads(EnumFacing.WEST));
//    combinedQuadsList.addAll(getNeedleQuads(EnumFacing.NORTH));
//    combinedQuadsList.addAll(getNeedleQuads(EnumFacing.SOUTH));
...
//  }
//
//  public List<BakedQuad> getNeedleQuads(EnumFacing whichFace)
//  {
//
//  }
//
...
//  {
//    throw new IllegalStateException("handleBlockState() should never be called for RedstoneMeterSmartBlockModel");
//  }
//
