...
// * For the restone meter block, it will map from
// *  RedstoneMeterISmartBlockModelFactory.modelResourceLocation to our RedstoneMeterISmartBlockModelFactory instance
// */
...
//  {
//    // Find the existing mapping for RedstoneMeterISmartBlockModelFactory - it will have been added automatically because
...
//    Object object =  event.modelRegistry.getObject(RedstoneMeterISmartBlockModelFactory.modelResourceLocation);
//    if (object instanceof IBakedModel) {
//      IBakedModel existingModel = (IBakedModel)object;
//      RedstoneMeterISmartBlockModelFactory customModel = new RedstoneMeterISmartBlockModelFactory(existingModel);
//      event.modelRegistry.putObject(RedstoneMeterISmartBlockModelFactory.modelResourceLocation, customModel);
//    }
//  }
//}
