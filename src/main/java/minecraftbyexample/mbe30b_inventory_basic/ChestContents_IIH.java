...
public class ChestContents_IIH implements IInventory {
   ...
   */
  public static ChestContents_IIH createForTileEntity(int size,
                                                      Predicate<PlayerEntity> canPlayerAccessInventoryLambda,
                                                      Notify markDirtyNotificationLambda) {
     return new ChestContents_IIH(size, canPlayerAccessInventoryLambda, markDirtyNotificationLambda);
  }
   ...
   * @return the new ChestContents
   */
  public static ChestContents_IIH createForClientSideContainer(int size) {
    return new ChestContents_IIH(size);
  }
  ...
  private ChestContents_IIH(int size) {
    this.chestContents = new ItemStackHandler(size);
  }

  private ChestContents_IIH(int size, Predicate<PlayerEntity> canPlayerAccessInventoryLambda, Notify markDirtyNotificationLambda) {
    this.chestContents = new ItemStackHandler(size);
    this.canPlayerAccessInventoryLambda = canPlayerAccessInventoryLambda;
    this.markDirtyNotificationLambda = markDirtyNotificationLambda;
  }
