...
public class BlockInventoryBasic_IIH extends ContainerBlock
{
	public BlockInventoryBasic_IIH()
	{
  ...
  public TileEntity createNewTileEntity(IBlockReader worldIn) {
    return new TileEntityInventoryBasic_IIH();
  }
  ...
  public void onReplaced(BlockState state, World world, BlockPos blockPos, BlockState newState, boolean isMoving) {
    if (state.getBlock() != newState.getBlock()) {
      ...
      if (tileentity instanceof TileEntityInventoryBasic_IIH) {
        TileEntityInventoryBasic_IIH tileEntityInventoryBasic = (TileEntityInventoryBasic_IIH)tileentity;
