...
* It lets you easily attach information to vanilla objects
...
On the down side:
* they're not as efficient as interfaces and methods
...
You can attach capability to most vanilla objects- if you look for classes which implement ICapabilityProvider you can see the complete list.  These classes include:
* Entity
* ItemStack
* TileEntity
* World
...
5) If an entity is tagged with both Fire and Air, it will explode the next time it takes any damage.
