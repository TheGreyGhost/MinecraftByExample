...
public class MinecraftByExample {
  ...
  public static void registerCommonEvents() {
    ...
    MOD_EVENT_BUS.register(minecraftbyexample.mbe30b_inventory_basic.StartupCommon.class);
  ...
  public static void registerClientOnlyEvents() {
    ...
    MOD_EVENT_BUS.register(minecraftbyexample.mbe30b_inventory_basic.StartupClientOnly.class);
