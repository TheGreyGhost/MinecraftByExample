...
public class StartupCommon
{
	...
	public static void preInitCommon()
	{
		 ...
		 * 2) an 'unlocalized name' that is used to retrieve the text name of your item in the player's language.  For example-
		 *    the unlocalized name might be "water", which is printed on the user's screen as "Wasser" in German or
		 *    "aqua" in Italian.
		 *
		 *  Multiple items can have the same unlocalized name - for example
