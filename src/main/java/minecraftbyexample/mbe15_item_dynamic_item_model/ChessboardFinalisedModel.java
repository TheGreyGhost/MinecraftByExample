...
//    }
  ...
  {
    // based on DefaultVertexFormats.BLOCK
    // BLOCK = new VertexFormat(ImmutableList.builder().add(POSITION_3F).add(COLOR_4UB).add(TEX_2F).add(TEX_2SB).add(NORMAL_3B).add(PADDING_1B).build());
