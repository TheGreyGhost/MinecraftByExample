...
public class StartupCommon
{
  ...
  public static AllMbeItemsItemGroup allMbeItemsItemGroup;        // will hold our second custom creative tab displaying all MBE item
...
//  A block can only be listed on one tab, unless you give it a custom ItemBlock which overrides .getCreativeTabs()
    ...
    allMbeItemsItemGroup = new AllMbeItemsItemGroup("mbe08_creative_tab_all_MBE");
  }
